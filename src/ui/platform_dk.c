...
#define APP_RING_AND_MOTION_LED			DK_LED1

/* Provisioning and FP advertising status LED. */
#define APP_PROVISIONING_LED			DK_LED1

/* Recovery mode and identification mode status LED. */
#define APP_MODE_LED				DK_LED1
...
#define APP_RING_AND_MOTION_BTN			DK_BTN1_MSK

/* Button used to change the battery level. */
#define APP_BATTERY_BTN				DK_BTN1_MSK

/* Button used to enter the following modes:
 * - recovery mode
 * - identification mode
 */
#define APP_MODE_CTLR_BTN			DK_BTN1_MSK

/* Button used perform a factory reset at the bootup (by polling the state). */
#define APP_FACTORY_SETTINGS_RESET_BTN		DK_BTN1_MSK
