...
/* Fast Pair discoverable advertising interval 100ms. */
#define FP_DISC_ADV_INTERVAL (0x00A0)

/* Fast Pair non-discovarable advertising interval 250ms. */
#define FP_NDISC_ADV_INTERVAL (0x0190)
...
static struct bt_le_adv_param fp_adv_param = {
	...
	.interval_min = FP_DISC_ADV_INTERVAL,
	.interval_max = FP_DISC_ADV_INTERVAL,
};
...
static int fp_adv_set_setup(void)
{
	...
	{
		fp_adv_param.interval_min = FP_NDISC_ADV_INTERVAL;
		fp_adv_param.interval_max = FP_NDISC_ADV_INTERVAL;
	}
	else
	{
		fp_adv_param.interval_min = FP_DISC_ADV_INTERVAL;
		fp_adv_param.interval_max = FP_DISC_ADV_INTERVAL;
	}
